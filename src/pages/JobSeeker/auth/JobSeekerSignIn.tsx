...
const JobSeekerSignIn = (props: Props) => {
  ...
  const onSubmit = (values: Object) => {
    ...
    const input = {
      ...rest,
      role: userRoles.JOB_SEEKER
    };
    jobSeekerSignIn(input).then(
      (response: any) => {
        ...
        navigate(routesURLs.JOB_SEEKER_MANAGEMENT + routesURLs.DASHBOARD);
      },
      (error: any) => {
    ...
    <>
      ...
      <Box sx={style}>
        <Grid container>
          ...
          <Grid item xs={12}>
            <Typography variant="h5">Job Seeker - Sign In</Typography>
          </Grid>
          <Grid item xs={12}>
            <Formik
                ...
                <Form id="PasswordVerification">
                  ...
                  >
                    ...
                    <Grid item xs={12}>
                      ...
                      <Link href="/job-seeker-signup">Sign up</Link> Here
                    </Grid>
                  </Grid>
                </Form>
              )}
