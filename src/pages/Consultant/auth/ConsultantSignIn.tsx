...
import { SignIn, consultantSignIn } from 'src/services/auth.service';
...
const ConsultantSignIn = (props: Props) => {
  ...
  const onSubmit = (values: Object) => {
    ...
    consultantSignIn(input).then(
      (response: any) => {
        ...
        navigate(routesURLs.CONSULTANT_MANAGEMENT + routesURLs.DASHBOARD);
      },
      (error: any) => {
    ...
    <>
      ...
      <Box sx={style}>
        <Grid container>
          ...
          <Grid item xs={12}>
            <Typography variant="h5">Consultant - Sign In</Typography>
          </Grid>
          <Grid item xs={12}>
            <Formik
                ...
                <Form id="PasswordVerification">
                  ...
                  >
                    ...
                    <Grid item xs={12}>
                      ...
                      <Link href="/consultant-signup">Sign up</Link> Here
                    </Grid>
                  </Grid>
                </Form>
              )}
