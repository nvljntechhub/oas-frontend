...
const LayoutComponent = (props: Props) => {
  ...
  useEffect(() => {
    ...
    if (consultantManagementIndex !== -1) {
      ...
      if (subPathAfterConsultantManagement === routesURLs.DASHBOARD) {
        ...
        setmodule(2);
      } else if (subPathAfterConsultantManagement === routesURLs.APPOINTMENT) {
        setmodule(3);
      }
    }
  }, []);
  ...
  const handleLogout = () => {
    ...
    localStorage.clear();
    navigate(routesURLs.CONSULTANT_SIGN_IN);
  };
  return (
    <>
          ...
          <List>
            ...
            <ListItem disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                component={RouterLink}
                to={routesURLs.CONSULTANT_MANAGEMENT + routesURLs.APPOINTMENT}
              >
                <ListItemIcon
                  sx={{
                    minWidth: 0,
