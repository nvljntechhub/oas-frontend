...
const LayoutComponent = (props: Props) => {
  ...
  const handleLogout = () => {
    ...
    localStorage.clear();
    navigate(routesURLs.ADMIN_SIGN_IN);
  };
  return (
    <>
            ...
            <Grid item>
              <Toolbar>
                ...
                <Typography variant="h6" noWrap component="div">
                  The JOBS - Online Appointment Scheduling Application
                </Typography>
              </Toolbar>
            </Grid>
            <Grid item mt={1.4}>
          ...
          <List>
            <ListItem disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                to={routesURLs.ADMIN_MANAGEMENT + routesURLs.CONSULTANT}
              >
                <ListItemIcon
                  sx={{
                    minWidth: 0,
            ...
            <ListItem disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                component={RouterLink}
                to={routesURLs.ADMIN_MANAGEMENT + routesURLs.JOB_SEEKER}
              >
                <ListItemIcon
                  sx={{
                    minWidth: 0,
            ...
            <ListItem disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                component={RouterLink}
                to={routesURLs.ADMIN_MANAGEMENT + routesURLs.APPOINTMENT}
              >
                <ListItemIcon
                  sx={{
                    minWidth: 0,
